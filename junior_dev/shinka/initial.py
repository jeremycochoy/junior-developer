...
TASK_SPEC = "Refactor the visualization code outside of the training class to an independent visualization instance."

INITIAL_PROMPT = """Please refactor the codebase to improve code quality and maintainability.
